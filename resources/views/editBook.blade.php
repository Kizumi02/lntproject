    ...
    <div class="m-5">
        ...
        <form action="{{route('update', $book->id )}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="exampleInputName" name="Name" value="{{$book->Name}}">
            </div>
            <div class="mb-3">
              <label for="exampleInputDate" class="form-label">Publication Date</label>
              <input type="date" class="form-control" id="exampleInputDate" name="PublicationDate" value="{{$book->PublicationDate}}"">
            </div>
            <div class="mb-3">
                <label for="exampleInputStock" class="form-label">Stock</label>
                <input type="number" class="form-control" id="exampleInputStock" name="Stock" value="{{$book->Stock}}">
            </div>
            <div class="mb-3">
                <label for="exampleInputAuthor" class="form-label">Author</label>
                <input type="text" class="form-control" id="exampleInputAuthor" name="Author" value="{{$book->Author}}">
            </div>
            <div class="mb-3">
