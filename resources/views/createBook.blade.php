    ...
    <div class="m-5">
        ...
        <form action="/store-book" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              @enderror id="exampleInputName" name="Name">
            </div>
            @error('Name')
            ...
            <div class="mb-3">
              ...
              <input type="date" value="{{old('PublicationDate')}}" class="form-control" id="exampleInputDate" name="PublicationDate">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" value="{{old('Stock')}}" class="form-control" id="exampleInputStock" name="Stock">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{old('Author')}}" class="form-control" id="exampleInputAuthor" name="Author">
            </div>
