    ...
    <div class="m-5">
        ...
        <form action="/store-category" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="exampleInputName" name="CategoryName" value="<?php echo e(old('CategoryName')); ?>">
            </div>
...
<?php /**PATH C:\XAMPPP\htdocs\lntjumat10\resources\views/createCategory.blade.php ENDPATH**/ ?>